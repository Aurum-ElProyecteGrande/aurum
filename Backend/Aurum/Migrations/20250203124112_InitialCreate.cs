    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RegularIncomeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegularIncomes", x => x.RegularIncomeId);
                    table.ForeignKey(
                        name: "FK_RegularIncomes_IncomeCategories_IncomeCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseSubCategories", x => x.ExpenseSubCategoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExpenseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExpenseCategoryId = table.Column<int>(type: "int", nullable: false),
                    ExpenseSubCategoryId = table.Column<int>(type: "int", nullable: true),
                    Label = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expenses_ExpenseSubCategories_ExpenseSubCategoryId",
                        column: x => x.ExpenseSubCategoryId,
                        principalTable: "ExpenseSubCategories",
                        principalColumn: "ExpenseSubCategoryId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegularExpenses_ExpenseSubCategories_ExpenseSubcategoryId",
                        column: x => x.ExpenseSubcategoryId,
                        principalTable: "ExpenseSubCategories",
                        principalColumn: "ExpenseSubCategoryId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegularExpenses_ExpenseSubcategoryId",
                table: "RegularExpenses",
                column: "ExpenseSubcategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_RegularIncomes_IncomeCategoryId",
