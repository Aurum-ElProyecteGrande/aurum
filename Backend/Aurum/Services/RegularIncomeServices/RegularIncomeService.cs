...
namespace Aurum.Services.RegularIncomeServices
{
    public class RegularIncomeService : IRegularIncomeService
    {
        ...
        public async Task<List<RegularIncomeDto>> GetAllRegularWithId(int accountId)
        {
            var incomes = await _regularIncomeRepo.GetAllRegularWithId(accountId);
        ...
        public async Task<List<RegularIncome>> GetAllRegular()
        {
	        return await _regularIncomeRepo.GetAllRegular();
        }
        ...
        private RegularIncomeDto ConvertRegularIncomeToDto(RegularIncome income)
        {
            ...
            var currency = new CurrencyDto(income.Account.CurrencyId, income.Account.Currency.Name, income.Account.Currency.CurrencyCode, income.Account.Currency.Symbol);
