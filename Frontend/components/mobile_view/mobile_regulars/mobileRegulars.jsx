...
import RegularCards from "@/components/regulars/regular_cards/RegularCards";
import { fetchAccounts, fetchRegularExpenses, fetchRegularIncome } from "@/scripts/dashboard_scripts/dashboard_scripts";
import MobileBottomBar from "@/components/mobile_view/mobile_dashboard_page/mobile_bottombar/MobileBottomBar";


export default function MobileRegularsPage() {
    ...
    return (
        <section className="transactions">
            ...
            {loading ?
                ...
                : <RegularCards data={filteredData} />}
            <MobileBottomBar />
        </section>
    );
}